...
final class TimeFormatterTests: XCTestCase {
    ...
    func testFormatTimeRemaining_ZeroSeconds() {
        ...
        XCTAssertEqual(result, "0h00m", "0秒は '0h00m' と表示されるべき")
    }
    ...
    func testFormatTimeRemaining_OneSecond() {
        ...
        XCTAssertEqual(result, "0h00m", "1秒は '0h00m' と表示されるべき")
    }
    ...
    func testFormatTimeRemaining_FiftyNineSeconds() {
        ...
        XCTAssertEqual(result, "0h00m", "59秒は '0h00m' と表示されるべき")
    }
    ...
    func testFormatTimeRemaining_OneMinute() {
        ...
        XCTAssertEqual(result, "0h01m", "60秒は '0h01m' と表示されるべき")
    }
    ...
    func testFormatTimeRemaining_OneMinuteOneSecond() {
        ...
        XCTAssertEqual(result, "0h01m", "61秒は '0h01m' と表示されるべき")
    }
    ...
    func testFormatTimeRemaining_FourMinutesThirtySeconds() {
        ...
        XCTAssertEqual(result, "0h04m", "4分30秒は '0h04m' と表示されるべき")
    }
    ...
    func testFormatTimeRemaining_FiftyNineMinutes() {
        ...
        XCTAssertEqual(result, "0h59m", "59分は '0h59m' と表示されるべき")
    }
    ...
    func testFormatTimeRemaining_OneHour() {
        ...
        XCTAssertEqual(result, "1h00m", "60分は '1h00m' と表示されるべき")
    }
    ...
    func testFormatTimeRemaining_OneHourOneMinute() {
        ...
        XCTAssertEqual(result, "1h01m", "1時間1分は '1h01m' と表示されるべき")
    }
    ...
    func testFormatTimeRemaining_TwoHours() {
        ...
        XCTAssertEqual(result, "2h00m", "2時間は '2h00m' と表示されるべき")
    }
    ...
    func testFormatTimeRemaining_FourHoursThirtyMinutes() {
        ...
        XCTAssertEqual(result, "4h30m", "4時間30分は '4h30m' と表示されるべき")
    }
    ...
    func testFormatTimeRemaining_PastTime() {
        ...
        XCTAssertEqual(result, "0h00m", "過去の時刻は '0h00m' と表示されるべき")
    }
}
